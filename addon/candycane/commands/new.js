...
module.exports = Command.extend({
  name: 'new',
  description: 'Creates a new directory and runs ' + chalk.green('candycane init') + ' in it.',
  ...
  run: function(commandOptions, rawArgs) {
    ...
    if (!packageName) {
      message = chalk.yellow('The `candycane ' + this.name + '` command requires a ' +
        'name argument to be specified. For more details, use `candycane help`.');
    ...
    if (packageName === '.') {
      message = 'Trying to generate an application structure in this directory? Use `candycane init` instead.';
