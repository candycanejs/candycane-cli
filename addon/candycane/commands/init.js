...
module.exports = Command.extend({
  name: 'init',
  description: 'Creates a new candycane-cli project in the current folder.',
  aliases: ['i'],
  works: 'everywhere',
  ...
  run: function(commandOptions, rawArgs) {
    ...
    if (!packageName) {
      var message = 'The `candycane ' + this.name + '` command requires a ' +
                    'package.json in current folder with name attribute or a specified name via arguments. ' +
                    'For more details, use `candycane help`.';
